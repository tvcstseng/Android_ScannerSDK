...
public class PairingInstructionsAll extends AppCompatActivity {
    ...
    private void reloadBarcode() {
        ...
        StringBuilder data2encode = new StringBuilder().append((char) 3);
        data2encode.append("92");
        GenerateBarcode128B barcode = new GenerateBarcode128B(data2encode.toString());
