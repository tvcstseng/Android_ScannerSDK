...
public class NotificationsActivity extends AppCompatActivity {
    ...
    protected void onPause() {
        ...
        settingsEditor.putBoolean(Constants.PREF_NOTIFY_AVAILABLE, ((Switch) findViewById(R.id.notAvailableScanner)).isChecked()).commit();
        settingsEditor.putBoolean(Constants.PREF_NOTIFY_ACTIVE, ((Switch) findViewById(R.id.notActiveScanner)).isChecked()).commit();
        settingsEditor.putBoolean(Constants.PREF_NOTIFY_BARCODE, ((Switch) findViewById(R.id.notBarcodeEvent)).isChecked()).commit();
        settingsEditor.putBoolean(Constants.PREF_NOTIFY_IMAGE, ((Switch) findViewById(R.id.notImageEvent)).isChecked()).commit();
        settingsEditor.putBoolean(Constants.PREF_NOTIFY_VIDEO, ((Switch) findViewById(R.id.notVideoEvent)).isChecked()).commit();
    }
}
