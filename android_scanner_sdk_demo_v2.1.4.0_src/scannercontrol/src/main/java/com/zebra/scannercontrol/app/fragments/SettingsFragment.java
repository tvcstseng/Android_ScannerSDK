    ...
    *
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(picklistMode!=null) {
            int picklistInt = ((ActiveScannerActivity) getActivity()).getPickListMode();
        ...
        if(txtVibration!=null && tblRowFW!=null) {
            boolean isPagerMotorAvailable= ((ActiveScannerActivity) getActivity()).isPagerMotorAvailable();
