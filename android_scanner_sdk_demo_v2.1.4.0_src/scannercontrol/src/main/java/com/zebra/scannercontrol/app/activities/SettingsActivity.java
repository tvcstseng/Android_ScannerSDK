...
public class SettingsActivity extends BaseActivity implements View.OnClickListener, OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterView.OnItemSelectedListener listner= new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                SharedPreferences.Editor settingsEditor = getSharedPreferences(Constants.PREFS_NAME, 0).edit();
                settingsEditor.putInt(Constants.PREF_COMMUNICATION_PROTOCOL_TYPE,selectedProtocolIndex).commit();
            }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        switch (buttonView.getId()) {
            case R.id.autoDetection: {
                ...
                settingsEditor.putBoolean(Constants.PREF_SCANNER_DETECTION, ((SwitchCompat) findViewById(R.id.autoDetection)).isChecked()).commit();
                break;
            }
    ...
    private boolean SettingsChangedFromDefaults() {
        ...
        if (autoDetection != null && availableScanner!=null && activeScanner!=null && barcodeEvent!=null && setDefaults!=null && barcodeType!=null) {
    ...
    private void SaveSettings() {
        ...
        SharedPreferences.Editor settingsEditor = getSharedPreferences(Constants.PREFS_NAME, 0).edit();
        if (autoDetection != null) {
            settingsEditor.putBoolean(Constants.PREF_SCANNER_DETECTION, autoDetection.isChecked()).commit();
        }
        if (availableScanner != null) {
    ...
    public void clearBTAddress(View view) {
        SharedPreferences.Editor settingsEditor = getSharedPreferences(Constants.PREFS_NAME, 0).edit();
        settingsEditor.putString(Constants.PREF_BT_ADDRESS, "").commit();
